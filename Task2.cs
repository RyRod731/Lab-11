...
{
    List<string> Names = new List<string>{ "Roger", "Bob", "Adam", "Alec", "Patrick", "Mario", "Luigi", "Ryan", "Michael", "Gabriel", "Raphael", "Uriel", "Daniel", "Karen", "Lucas", "Andres", "Ben", "Hilda", "Zack", "Vincent"};
